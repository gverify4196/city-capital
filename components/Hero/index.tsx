            ...
            <div className="w-full px-4">
              ...
              >
                ...
                <p className="mb-12 text-base font-medium !leading-relaxed text-body-color dark:text-white dark:opacity-90 sm:text-lg md:text-xl">
                  Can’t quite find the right home to fit your budget? Are you just beginning the process of purchasing, but not sure where to start? 
                  Have a home picked out but no land to put it on? Looking to trade-in?
                </p>
